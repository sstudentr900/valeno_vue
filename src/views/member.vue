<template>
    <div class="member">
        <div class="left" id="login">
            ...
            <form action="member_center.html" name="form_login">
        ...
        <div class="right" id="join">
            ...
            <router-link to="/member_register" class="public_btn white" title="立即加入網站會員">立即加入會員</router-link>
            ...
            <div class="shopping">
                ...
                <a href="flow_cart.html" class="public_btn" title="前往結帳">前往結帳</a>
            </div>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .member .right .public_btn {
        margin-top: 15px;
    }
    .member .right .shopping{
        margin-top: 30px;
    }
</style>
